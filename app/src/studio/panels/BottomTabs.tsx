 ...
 * "Validation / Compile"(ValidationPanel) | "Runtime Preview"(RuntimePreviewPanel) 두 탭을 가지며,
...
type BottomTabId = "validation" | "runtime";
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minHeight: 0, overflow: "hidden" }}>
        {activeTab === "validation" ? <ValidationPanel /> : <RuntimePreviewPanel />}
      </div>
    </section>
  );
}
